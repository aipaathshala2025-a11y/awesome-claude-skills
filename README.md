...
- [MarkItDown](https://github.com/microsoft/markitdown) - Converts PDFs, Office documents, images, audio, HTML, and other formats to Markdown for LLM ingestion and RAG pipelines. *By [@microsoft](https://github.com/microsoft)*
